                        ...
                        <tbody>
                            @forelse ($standar as $index => $stndar)
                                <tr>
                                    ...
                                    <td>
                                        <div class="d-flex">
                                            <a href="#" data-url="{{ route('web.ami.standar.show', $stndar->id) }}"
                                            ...
                                            <button class="btn btn-danger shadow btn-xs sharp btn-delete"
                                                data-url="{{ route('web.ami.standar.show', $stndar->id) }}"><i
            ...
            <div class="modal-content">
                ...
                <div class="modal-body">
                    <div class="form-validate">
                        <form class="needs-validation" novalidate="" action="{{ route('web.ami.standar.store') }}"
                            method="post">
                            @csrf
                            <div class="row">
                                <div class="mb-4">
