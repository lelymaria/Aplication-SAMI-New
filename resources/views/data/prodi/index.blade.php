                            ...
                            @forelse ($prodi as $index => $program_studi)
                                <tr>
                                    ...
                                    <td>
                                        <div class="d-flex">
                                            <a href="#"
                                                data-url="{{ route('web.data.prodi.show', $program_studi->id) }}"
                                            ...
                                            <button class="btn btn-danger shadow btn-xs sharp btn-delete"
                                                data-url="{{ route('web.data.prodi.show', $program_studi->id) }}"><i
    ...
    <div class="modal fade" id="basicModal">
        <div class="modal-dialog" role="document">
            <div class="modal-content">
                ...
                <form class="needs-validation" novalidate="" action="{{ route('web.data.prodi.store') }}" method="post">
                    @csrf
