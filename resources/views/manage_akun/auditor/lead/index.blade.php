                                                            ...
                                                            <tr>
                                                                ...
                                                                <td>
                                                                    @if ($lead_auditor->akunAuditor?->prodi)
                                                                        {{ $lead_auditor->akunAuditor?->prodi->nama_prodi }}
                                                                    @else
                                                                ...
                                                                <td>
                                                                    <div class="d-flex">
                                                                        <div class="d-flex">
                                                                            <a href="{{ route('web.manage-user.lead-auditor.edit', $lead_auditor->id) }}"
                                                                                class="btn btn-primary shadow btn-xs sharp me-1 btn-edit"><i
                                                                                    class="fas fa-pencil-alt"></i></a>
                                                                            <button
                                                                                class="btn btn-danger shadow btn-xs sharp btn-delete"
                                                                                data-url="{{ route('web.manage-user.lead-auditor.destroy', $lead_auditor->id) }}"><i
    ...
    <div class="modal fade" id="basicModal">
        <div class="modal-dialog" role="document">
            <div class="modal-content">
                ...
                <form class="needs-validation" novalidate="" action="{{ route('web.manage-user.lead-auditor.store') }}"
                    method="post">
                    @csrf
