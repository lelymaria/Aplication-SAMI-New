...
@section('content')
    ...
    <div class="row page-titles">
        <ol class="breadcrumb">
            ...
            <li class="breadcrumb-item active"><a href="{{ route('web.manage-user.lead-auditor.index') }}">Auditor</a></li>
                ...
                <div class="card-body">
                    <div class="form-validation">
                        <form class="needs-validation" novalidate=""
                            action="{{ route('web.manage-user.lead-auditor.update', $update_akun_auditor->id) }}"
                            method="post">
                            @csrf
                            @method('put')
                            <div class="row">
                                            ...
                                            <select name="histori_ami_id" class="form-control form-select">
                                                @foreach ($histori_amis as $histori_ami)
                                                    <option value="{{ $histori_ami->id }}"
                                                        {{ $histori_ami->id == $update_akun_auditor->userHasLevelNotActive->histori_ami_id ? 'selected' : '' }}>
                                ...
                                <div class="col-xl-6">
                                    <div class="mb-3 row">
                                        ...
                                        <div class="col-lg-6">
                                            <input type="text" class="form-control" id="validationCustom03"
                                                name="nama" value="{{ $update_akun_auditor->name }}"
                                    ...
                                    <div class="mb-3 row">
                                        ...
                                        <div class="col-lg-6">
                                            <input type="text" class="form-control" id="validationCustom03"
                                                name="email" value="{{ $update_akun_auditor->email }}"
                                            ...
                                            <select name="level_id" class="form-control form-select">
                                                @foreach ($levels as $level)
                                                    <option value="{{ $level->id }}"
                                                        {{ $level->id == $update_akun_auditor->userHasLevelNotActive->level_id ? 'selected' : '' }}>
                                                        {{ $level->name }}</option>
                                                @endforeach
                                            </select>
                                        </div>
        ...
        <div class="col-lg-12">
            <div class="card">
                <div class="card-body">
                    <div class="form-validation">
                        <form class="needs-validation" novalidate=""
                            action="{{ route('web.manage-user.update-password', $update_akun_auditor->id) }}"
                            method="post">
                            @csrf
                            @method('put')
                            <div class="row">
