                ...
                <div class="profile-head">
                    ...
                    <div class="profile-info">
                        <div class="profile-photo">
                            <img src="{{ asset($update_akun_kepalaP4mp->foto_profile) }}" class="img-fluid rounded-circle"
                                alt="" style="width: 100px; height: 100px">
                        </div>
                        <div class="profile-details">
                            <div class="profile-name px-3 pt-2">
                                <h4 class="text-primary mb-0">{{ $update_akun_kepalaP4mp->nama }}</h4>
                                <p>{{ $update_akun_kepalaP4mp->userHasLevelNotActive->level->name }}</p>
                            </div>
                ...
                <div class="card-body">
                    <div class="form-validation">
                        <form class="needs-validation" novalidate=""
                            action="{{ route('web.manage-user.kepala-p4mp.update', $update_akun_kepalaP4mp->id) }}"
                            method="post">
                            @csrf
                            @method('put')
                            <div class="row">
                                    ...
                                    <div class="mb-3 row">
                                        ...
                                        <div class="col-lg-6">
                                            <input type="text" class="form-control" id="validationCustom01"
                                                ...
                                                value="{{ $update_akun_kepalaP4mp->kepalaP4mp->periode_jabatan }}">
                                        </div>
                                    </div>
                                    <div class="mb-3 row">
                                        ...
                                        <div class="col-lg-6">
                                            <input type="text" class="form-control" id="validationCustom02"
                                                ...
                                                value="{{ $update_akun_kepalaP4mp->email }}">
                                        </div>
                                    </div>
                                    <div class="mb-3 row">
                                        <label class="col-lg-4 col-form-label" for="validationCustom02">Tahun Pelaksanaan
                                        </label>
                                        <div class="col-lg-6">
                                            <select name="histori_ami_id" class="form-control form-select">
                                                @foreach ($histori_amis as $histori_ami)
                                                    <option value="{{ $histori_ami->id }}"
                                                        {{ $histori_ami->id == $update_akun_kepalaP4mp->userHasLevelNotActive->histori_ami_id ? 'selected' : '' }}>
                                                        {{ $histori_ami->tahun_ami }}</option>
                                                @endforeach
                                            </select>
                                        </div>
                                    </div>
                                    ...
                                    <div class="mb-3 row">
                                        ...
                                        <div class="col-lg-6">
                                            <input type="text" class="form-control" id="validationCustom03"
                                                ...
                                                value="{{ $update_akun_kepalaP4mp->nip }}">
                                        </div>
                                    </div>
                                    <div class="mb-3 row">
                                        ...
                                        <div class="col-lg-6">
                                            <input type="text" class="form-control" id="validationCustom03"
                                                ...
                                                value="{{ $update_akun_kepalaP4mp->name }}">
                                        </div>
                                    </div>
                                    <div class="mb-3 row">
                                            ...
                                            <select name="level_id" class="form-control form-select">
                                                @foreach ($levels as $level)
                                                    <option value="{{ $level->id }}"
                                                        {{ $level->id == $update_akun_kepalaP4mp->userHasLevelNotActive->level_id ? 'selected' : '' }}>
                                                        {{ $level->name }}</option>
                                                @endforeach
                                            </select>
                                        </div>
        ...
        <div class="col-lg-12">
            <div class="card">
                <div class="card-body">
                    <div class="form-validation">
                        <form class="needs-validation" novalidate=""
                            action="{{ route('web.manage-user.update-password', $update_akun_kepalaP4mp->id) }}"
                            method="post">
                            @csrf
                            @method('put')
                            <div class="row">
